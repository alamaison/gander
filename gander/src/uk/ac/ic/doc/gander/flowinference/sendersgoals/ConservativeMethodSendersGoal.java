...
public final class ConservativeMethodSendersGoal implements SendersGoal {
	...
	public ConservativeMethodSendersGoal(Model model, Function method) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ConservativeMethodSendersGoal other = (ConservativeMethodSendersGoal) obj;
		if (method == null) {
