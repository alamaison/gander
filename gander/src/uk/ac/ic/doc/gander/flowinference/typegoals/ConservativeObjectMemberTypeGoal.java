 ...
 */
final class ConservativeObjectMemberTypeGoal implements TypeGoal {

	private final Model model;
	private final Class klass;
	private final String memberName;

	ConservativeObjectMemberTypeGoal(Model model, Class klass, String memberName) {
		this.model = model;
		this.klass = klass;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ConservativeObjectMemberTypeGoal other = (ConservativeObjectMemberTypeGoal) obj;
		if (memberName == null) {
