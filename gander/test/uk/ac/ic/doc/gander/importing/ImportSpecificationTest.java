...
public final class ImportSpecificationTest {
	...
	public void importTriple() throws Throwable {
		ImportSpecification info = ImportSpecificationFactory.newImport("a.b.c");
	...
	public void importSingleAs() throws Throwable {
		ImportSpecification info = ImportSpecificationFactory.newImportAs("x", "y");
	...
	public void importDoubleAs() throws Throwable {
		ImportSpecification info = ImportSpecificationFactory.newImportAs("p.q", "r");
	...
	public void importTripleAs() throws Throwable {
		ImportSpecification info = ImportSpecificationFactory.newImportAs("a.b.c", "d");
	...
	public void fromImportSingle() throws Throwable {
		ImportSpecification info = ImportSpecificationFactory.newFromImport("x", "i");
	...
	public void fromImportDouble() throws Throwable {
		ImportSpecification info = ImportSpecificationFactory.newFromImport("p.q", "s");
	...
	public void fromImportTriple() throws Throwable {
		ImportSpecification info = ImportSpecificationFactory.newFromImport("a.b.c", "m");
	...
	public void fromImportSingleAs() throws Throwable {
		ImportSpecification info = ImportSpecificationFactory.newFromImportAs("x", "i", "j");
	...
	public void fromIimportDoubleAs() throws Throwable {
		ImportSpecification info = ImportSpecificationFactory.newFromImportAs("p.q", "s", "t");
	...
	public void fromImportTripleAs() throws Throwable {
		ImportSpecification info = ImportSpecificationFactory.newFromImportAs("a.b.c", "m", "n");
